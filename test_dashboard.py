...
def create_sample_data():
    ...
    if not os.path.exists("logs/deployment_log.csv"):
        ...
        sample_deploy.to_csv("logs/deployment_log.csv", index=False)
    ...
    if not os.path.exists("logs/healing_log.csv"):
        ...
        sample_heal.to_csv("logs/healing_log.csv", index=False)
    ...
    if not os.path.exists("logs/issue_log.csv"):
        ...
        sample_issues.to_csv("logs/issue_log.csv", index=False)
    ...
    if not os.path.exists("logs/uptime_log.csv"):
        ...
        sample_uptime.to_csv("logs/uptime_log.csv", index=False)
